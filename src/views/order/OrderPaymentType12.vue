    ...
    <article class="order_info" :class="[isOpen ? 'toggle_open' : 'toggle_hide']">
        ...
        <div class="toggle_box" v-show="isOpen">
            <div class="payment_type_box">
                <div class="warning_txt" v-html="UnablePay[0].text"></div>
                <div class="banner" v-show="UnablePay[0].bannerActive">
                ...
                <div class="btns">
                    ...
                    <span class="btn_box">
                        <button
                            type="button"
                            :disabled="UnablePay[0].depositWithoutBankbookActive"
                        >
                            무통장입금
                        </button>
                    </span>
                    <span class="btn_box">
                        <button type="button" :disabled="UnablePay[0].npayActive">
                            <img
                    ...
                    <span class="btn_box">
                        <button type="button" :disabled="UnablePay[0].tossActive">
