<!-- 결제불가 -  총 주문 금액 50만원 초과 & 깜짝 배송 선택 배너 X -->
<template>
    <article class="order_info" :class="[isOpen ? 'toggle_open' : 'toggle_hide']">
        ...
        <div class="toggle_box" v-show="isOpen">
            <div class="payment_type_box">
                <div class="warning_txt" v-html="UnablePay[1].text"></div>
                <div class="banner" v-show="UnablePay[1].bannerActive">
                ...
                <div class="btns">
                    ...
                    <span class="btn_box">
                        <button
                            type="button"
                            :disabled="UnablePay[1].depositWithoutBankbookActive"
                        >
                            무통장입금
                        </button>
                    </span>
                    <span class="btn_box">
                        <button type="button" :disabled="UnablePay[1].npayActive">
                            <img
                    ...
                    <span class="btn_box">
                        <button type="button" :disabled="UnablePay[1].tossActive">
