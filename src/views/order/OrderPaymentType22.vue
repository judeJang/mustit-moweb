<!-- 결제수단 disabled 처리 시 안내 문구 위치 변경 -->
<template>
    <article class="order_info" :class="[isOpen ? 'toggle_open' : 'toggle_hide']">
        ...
        <div class="toggle_box" v-show="isOpen">
            <div class="payment_type_box">
                <div class="banner" v-show="UnablePay[4].bannerActive">
                ...
                <div class="btns">
                    ...
                    <span class="btn_box">
                        <button
                            type="button"
                            :disabled="UnablePay[4].depositWithoutBankbookActive"
                        >
                            무통장입금
                        </button>
                    </span>
                    <span class="btn_box">
                        <button type="button" :disabled="UnablePay[4].npayActive">
                            <img
                    ...
                    <span class="btn_box">
                        <button type="button" :disabled="UnablePay[4].tossActive">
                ...
                <div class="notice_list_box">
                    <ul class="notice_list">
                        <li>총 주문금액이 50만원 초과 시 무통장 입금이 불가합니다.</li>
                        <li>2개 이상 상품 주문 시 토스 결제가 불가합니다.</li>
                    </ul>
                </div>
            ...
            return {
                ...
                UnablePay: [
                    ...
                    }, // 총 주문 금액 50만원 초과 & 2개 이상 주문 -> 무통장 입금 불가 / 토스페이 불가
                    {
                        ...
                        depositWithoutBankbookActive: false,
                        npayActive: true,
                        tossActive: true,
                        bannerActive: true
                    }, // 깜짝 배송 선택 -> 토스&N페이 불가
